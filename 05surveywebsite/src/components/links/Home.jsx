    ...
    <div className='flex flex-col min-h-screen'>
        <div className='flex-grow'>
            <div className='p-8 w-full md:px-24'>
                ...
                {/* Here inject the points*/}
                
                <h1 className='font-bold text-xl md:text-4xl mt-4'>Tasks</h1>

                <div className="flex flex-col items-start border-2 p-4 w-fit rounded-lg mt-8 bg-gradient-to-br from-violet-600 to-orange-500 outline-none mb-12" id='survey-card'>
